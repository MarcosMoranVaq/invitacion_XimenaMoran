...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof AOS !== 'undefined') {
        ...
        console.log("⚠️ AOS no disponible");
    }
    ...
    console.log("- Botón abrir:", openModalBtn);
    console.log("- Botón cerrar:", closeModalBtn);
    console.log("- Formulario:", rsvpForm);
    ...
    if (openModalBtn) {
        console.log("✅ Botón 'Confirmar asistencia' encontrado, asignando evento...");
        openModalBtn.addEventListener('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
            console.log("🖱️ Click en botón Confirmar asistencia");
            openModal();
        });
    } else {
        console.error("❌ ERROR: No se encontró el botón con id 'openRsvpModalBtn'");
    }
    ...
    // Prevenir scroll dentro del modal
    if (modal) {
    ...
    // ===== FORMULARIO =====
    if (rsvpForm) {
        console.log("✅ Formulario encontrado, asignando evento de envío...");
        rsvpForm.addEventListener('submit', function(e) {
            ...
            console.log("Datos:", { name, count, message });
        ...
        console.error("❌ ERROR: No se encontró el formulario con id 'rsvpForm'");
    }
    ...
    if (reminderBtn) {
        reminderBtn.addEventListener('click', function(e) {
            e.preventDefault();
            console.log("📅 Click en botón recordatorio");
